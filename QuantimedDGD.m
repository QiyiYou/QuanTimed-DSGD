%% NN parameters
input_layer_size  = 784;  % 28*28 Input Images for MNIST
...
c1 = 0.3; %Step Sizes
c2 = 15;
vmin = 10; % minimum computations speed
...
%% plot
semilogy ([0,finaltimeDB(1,:)],[cost(1),finalcostDB(1,:)]);
hold on
semilogy ([0,finaltimeDB(2,:)],[cost(1),finalcostDB(2,:)]);
